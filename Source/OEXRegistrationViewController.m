...
- (void)initializeViews {
    ...
    [self.registerButton applyButtonStyleWithStyle:[self.environment.styles filledSecondaryButtonStyle] withTitle:[Strings registrationCreateMyAccount]];
...
- (void)showProgress:(BOOL)status {
    if(status) {
        ...
        [self.registerButton applyButtonStyleWithStyle:[self.environment.styles filledSecondaryButtonStyle] withTitle:[Strings registrationCreatingAccount]];

...
- (void)initializeViews {
    ...
    [self.registerButton applyButtonStyleWithStyle:[self.environment.styles filledButtonStyleWithColor:[self.environment.styles secondaryBaseColor]] withTitle:[Strings registrationCreateMyAccount]];
...
- (void)showProgress:(BOOL)status {
    if(status) {
        ...
        [self.registerButton applyButtonStyleWithStyle:[self.environment.styles filledButtonStyleWithColor:[self.environment.styles secondaryBaseColor]] withTitle:[Strings registrationCreatingAccount]];

...
class EnrolledCoursesFooterView : UIView {
    ...
    init() {
        ...
        self.findCoursesButton.applyButtonStyle(style: OEXStyles.shared().filledButtonStyle(color: OEXStyles.shared().secondaryBaseColor()), withTitle: Strings.EnrollmentList.findCourses.oex_uppercaseStringInCurrentLocale())

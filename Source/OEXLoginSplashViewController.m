...
- (void)viewDidLoad {
    ...
    [self.signUpButton applyButtonStyle:[self.environment.styles filledButtonStyle:self.environment.styles.primaryBaseColor] withTitle:[Strings loginSplashSignUp]];
}

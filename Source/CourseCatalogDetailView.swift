...
class CourseCatalogDetailView : UIView, UIWebViewDelegate {
    ...
    let actionButton = SpinnerButton(type: .system)
...
extension CourseCatalogDetailView {
    ...
    func invitationOnlyBtn(text: String) {
        self.actionButton.applyButtonStyle(style: OEXStyles.shared().filledButtonStyle(color: UIColor(hexString: "A7A4A4", alpha: 1.0)), withTitle: text)

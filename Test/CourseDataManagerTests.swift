...
class CourseDataManagerTests: XCTestCase {
    ...
    func testModeChangedAnalytics() {
        ...
        let courseDataManager = CourseDataManager(analytics: environment.analytics, interface: nil, networkManager: environment.networkManager, session: environment.session)
